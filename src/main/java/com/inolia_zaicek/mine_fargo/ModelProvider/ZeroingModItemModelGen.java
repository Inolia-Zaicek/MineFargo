package com.inolia_zaicek.mine_fargo.ModelProvider;
...
public class ZeroingModItemModelGen extends ItemModelProvider {
    ...
    public ZeroingModItemModelGen(PackOutput output, ExistingFileHelper existingFileHelper){
        //第二个参数要填自己的modid
        super(output, MineFargo.MODID,existingFileHelper);
    }
    ...
    protected void registerModels() {
        ...
        for(RegistryObject<Item> itemsDeferredRegister: MyGoItemRegister.CommonItem){
    ...
    public ResourceLocation resourceItem(String path){
        return new ResourceLocation(MineFargo.MODID,"item/"+path);
    }
}
