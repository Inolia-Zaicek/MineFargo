...
public class UseItemEvent {
    ...
    public static void useItemEvent(LivingEntityUseItemEvent.Finish event) {
        ...
        if (livingEntity != null) {
            ...
            //蘑菇煲
            if (MyGoUtil.hasNature(curios,livingEntity, MushroomSoulStone.get()) &&
                    //碗装食物
            ...
            if (ModList.get().isLoaded("ars_nouveau")) {
                if (MyGoUtil.hasNature(curios,livingEntity, WhirlisprigSoulStone.get()) &&
                        //可食用
            ...
            if (ModList.get().isLoaded("farmersdelight")) {
                if (MyGoUtil.isCurioEquipped(livingEntity, MyGoItemRegister.FarmerDelightSoulStone.get()) && event.getItem().getItem().isEdible()) {
